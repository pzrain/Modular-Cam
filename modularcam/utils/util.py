...
from modularcam.utils.convert_lora_safetensor_to_diffusers import convert_lora, load_diffusers_lora
...
def save_videos_grid(videos: torch.Tensor, path: str, rescale=False, n_rows=6, fps=8):
    ...
    #     imageio.imwrite(path + "_%d.png" % (i), outputs[i])
    imageio.imwrite(path + "_start.png", outputs[0])
    imageio.imwrite(path + "_second.png", outputs[1])
    imageio.imwrite(path + "_end.png", outputs[-1])
...
def load_weights(
    ...
    if motion_module_path != "":
        ...
        unet_state_dict.pop("modularcam_config", "")
    ...
    if adapter_lora_path != "":
        ...
        domain_lora_state_dict.pop("modularcam_config", "")
    ...
    for motion_module_lora_config in motion_module_lora_configs:
        ...
        motion_lora_state_dict.pop("modularcam_config", "")
